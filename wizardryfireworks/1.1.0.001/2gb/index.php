		...
		<div id="mainborder">
			<div id="mainleft">
				...
				<div id="maincontent">
					...
					<div id="content">
						<div class="maintitle">Greg Coorey Talks to Murrey Wilton Live on 2GB</div>
						<div class="padding10 centertext">
							<object type="audio/mpeg" data="greg_2gb.mp3" width="200" height="20">
								<param name="src" value="greg_2gb.mp3" />
								<param name="autoplay" value="false" />
								<param name="autoStart" value="0" />
							</object>
							<p><a href="/greg_2gb.mp3" class="text">download mp3 here (right click - save as)</a></p>
						</div>
					</div>
				</div>
			</div>
