								...
								<tr>
									<td valign="top" class="logo-text">
										...
										<table cellspacing="0" cellpadding="0" class="data-table-3col">
											<tbody>
												<tr>
													<td class="news_head">Name: </td>
													<td class="news_head">Position &amp; profile: </td>
													<td class="news_head">Name: </td>
													<td class="news_head">Position &amp; profile: </td>
												</tr>
												<tr>
													<td class="profile_name">Greg Coorey</td>
													<td class="profile_years">Head Pyrotechnician</td>
										
													<td class="profile_name">David Coorey</td>
													<td class="profile_years">Pyrotechnician</td>
												</tr>
												<tr>
													<td class="profile_name">Anthony Doumit</td>
													<td class="profile_years">Pyrotechnician</td>
										
													<td class="profile_name">Ian Blott</td>
													<td class="profile_years">Pyrotechnician</td>
												</tr>
												<tr>
													<td class="profile_name">Phil Lane</td>
													<td class="profile_years">Pyrotechnician</td>
										
													<td class="profile_name">James Gold</td>
													<td class="profile_years">Trainee Pyrotechnician</td>
												</tr>
											</tbody>
										</table>
									</td>
