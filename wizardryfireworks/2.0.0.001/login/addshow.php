		...
		<form method="post" action="#">
			<table border="0" cellpadding="0" cellspacing="0" class="admin-table">
				<tr> 
					...
					<td valign="middle"><input type="text" name="show_Location" size="20" maxlength="50" /></td>
				</tr>
				<tr> 
					<td valign="middle">Clients Name :</td>
					<td valign="middle"><input type="text" name="client_name" size="20" maxlength="50" /></td>
					<td valign="middle">Type :</td>
					<td valign="middle"><input type="text" name="show_type" size="20" maxlength="30" /></td>
				</tr>
				<tr> 
					<td valign="middle">Firing Time :</td>
					<td valign="middle">
					...
					<td valign="middle">Work start :</td>
					<td valign="middle">
				...
				<tr> 
					<td valign="middle">Work Finish :</td>
					<td valign="middle">
					...
					<td valign="middle">Collect Money :</td>
					<td valign="middle">
				...
				<tr> 
					...
					<td valign="middle"><input type="text" name="show_Price" size="20" maxlength="25" /></td>
					<td valign="middle">Description :</td>
					<td valign="middle"><input type="text" name="show_description" size="20" maxlength="255" /></td>
				</tr>
				<tr> 
					<td valign="middle">Staff Needed :</td>
					<td valign="middle">
					...
					<td colspan="2" valign="middle" align="center"><input onclick="alert('Function Disabled');" type="submit" name="Submit" value="submit" /></td>
				</tr>
				<tr>
