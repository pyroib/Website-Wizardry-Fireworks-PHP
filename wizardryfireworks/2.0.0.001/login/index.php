						...
						<div class="padding10">
							...
							<div id="contactus">
								<form action="/login/admin.php" method="post">
									<fieldset>		
										<label for="txtstaff_Id">Staff ID</label><input type="text" maxlength="40" size="30" id="txtstaff_Id" />
										<label for="txtstaff_pw">Password</label><input type="text" maxlength="50" size="30" id="txtstaff_pw" />
